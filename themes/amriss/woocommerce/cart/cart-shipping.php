	...
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
		...
		<?php if ( 1 < count( $available_methods ) ) : ?>
			<ul id="shipping_method">
				<?php 
					// Added later, woocommerce changed Both <label> to Cash on Delivery, we want only the 2nd <lable> to change
					// $counter = 0; 
					// no need, you can change the Title of Local Pickup to anyghing you like from the Admin Panel. ShippinZones -> Local -> Local Pickup
					foreach ( $available_methods as $method ) : 
				?>
				<li>
					<?php
						// fanos:: removed %5$s From <label for="shipping_method_%1$d_%2$s">%5$s</label>
